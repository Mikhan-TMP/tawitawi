    ...
    public function import_Student_File(){
      ...
      if ($this->input->post('submit')) {
                ...
                try {
                    ...
                    if($result){
                      $this->session->set_flashdata('student_scs', 'Student Files Uploaded Successfully!');
                        redirect('master/student');
                    }else{
                      $this->session->set_flashdata('student_fail', 'Student Files Upload Failed!');
                      redirect('master/student');
                    }             
    ...
    public function import_Faculty_File(){
      ...
      if ($this->input->post('submit')) {
                ...
                try {
                    ...
                    if($result){
                      $this->session->set_flashdata('faculty_scs', 'Faculty Files Uploaded Successfully!');
                        redirect('master/faculty');
                    }else{
                      $this->session->set_flashdata('faculty_fail', 'Faculty Files Upload Failed!');
                      redirect('master/faculty');
                    }             
