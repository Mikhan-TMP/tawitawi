...
<head>
  ...
  <title>Library Room History</title>
</head>
<a id="printButton" class="btn btn-success m-5" href="<?= base_url('report/attend_room/')?>">Back</a>
<style>
  @media print {
    #printButton {
      display: none;
...
<body>
  <div class="container border p-5">
    ...
    <div class="row mb-2">
      <div class="col">
        <h2 class="text-center">Library Room History</h2>
      </div>
    </div>
    <div class="row mb-3">
      <div class="col-6">
