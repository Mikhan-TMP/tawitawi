...
<head>
  ...
  <title>Library Seat History</title>
</head>
<a id="printButton" class="btn btn-success m-5" href="<?= base_url('report/attend_seat/')?>">Back</a>
<style>
  @media print {
    #printButton {
      display: none;
...
<body>
  <div class="container border p-5 ">
    <div class="col text-center p-2">
      <img src="<?= base_url('images/'); ?>LIBRARY.png" alt="" width="125px">
      <h5 class="h5">Mindanao State University - General Santos City</h5>
    </div>
    <div class="row mb-2">
      <div class="col">
        <h2 class="text-center">Library Seat History</h2>
      </div>
    </div>
    <div class="row mb-3">
      <div class="col-6">
