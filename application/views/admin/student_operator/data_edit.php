<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h1 class="h3 mb-4 text-gray-800">Student Data</h1>
            <!-- <a href="<?= base_url('Data_Master/student') ?>" class="btn btn-md btn-info mb-2">Back</a> -->
