    ...
    <div class="row">
        <div class="col-sm-12 col-lg-12 ml-auto ">
            <form action="" method="GET">
                <div class="row">
                    <div class="col-2">
                        <input type="date" name="start" placeholder="<?php echo $date ?>" value=<?= $date ?>
                            class="form-control">
                    ...
                    <div class="col-sm-1 col-1">
                        <button type="submit" name="submit" value="Show"
                            class="btn btn-success btn-fill btn-block text-white"
                            style="background: linear-gradient(180deg, #031084, #000748);  width: 100px;  border:none; border-radius: 15px">
