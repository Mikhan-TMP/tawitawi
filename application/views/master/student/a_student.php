...
<div class="container-fluid">
    ...
    <div class="col-lg-6 p-0 m-auto ">
        ...
        <div class="card" style="border-radius:15px;">
            <h3 class="mb-0 text-left text-light" style="background: linear-gradient(180deg, #031084, #000748); 
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group mt-4" style="display: flex; flex-direction: column;">
                            ...
                            <input type="text" minlength="2" maxlength="30" class="form-control col-lg" name="f_name"
                                id="f_name" required autofocus
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mt-4" style="display: flex;flex-direction: column;">
                            ...
                            <input type="text" minlength="2" maxlength="30" class="form-control col-lg" name="l_name"
                                id="l_name" required\ style="border-radius:15px; font-size: 1rem; padding: 25px;"
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mt-4" style="display: flex;flex-direction: column;">
                            ...
                            <input type="text" minlength="2" maxlength="30" class="form-control col-lg" name="srcode"
                                id="srcode" required style="border-radius:15px; font-size: 1rem; padding: 25px;"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mt-4" style="    display: flex;flex-direction: column;">
                            ...
                            <input type="text" minlength="2" maxlength="50" class="form-control col-lg" name="college"
                                id="college" required style="border-radius:15px; font-size: 1rem; padding: 25px;"
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mt-4" style="display: flex;flex-direction: column;">
                            ...
                            <input type="text" minlength="2" maxlength="50" class="form-control col-lg" name="course"
            ...
            <div class="form-group mt-4" style="    
              ...
              <div class="form-check form-check-inline my-0" >
                ...
                <div class="row">
                    <div class="w-100">
                        <button type="submit"
                            style="background: linear-gradient(180deg, #031084, #000748);  border:none; padding: 5px; border-radius: 15px;"
